...
public class MultiplicationZKP extends ZKP {
	...
	public boolean verifyPlaintext() {
...
class check{
		...
		//PaillierKey key1 = new PaillierKey();
		//BigInteger keyn = key1.nextBigInteger();
		//BigInteger key1 = reader.nextBigInteger();
		System.out.println("Enter ca: "); 
		BigInteger ca1 = reader.nextBigInteger();
		...
		PaillierKey key1 = new PaillierKey(p,q,seed);

		// Object demo = new MultiplicationZKP();
		// demo.MultiplicationZKP(key1, ca1, alpha1);


		// BigInteger dValue;
		// System.out.println(dValue.getValue());
		reader.close();


		MultiplicationZKP yes = new MultiplicationZKP(key1, ca1, alpha1);
		//yes.MultiplicationZKP(key1, ca1, alpha1);
		//Method multiplyInstanceMethod = Operations

		//MultiplicationZKP(key1, ca1, alpha1);
		//verify();
